  ...
  <div className="min-h-screen bg-slate-50 p-8 flex justify-center items-start pt-20">
    <div className="max-w-2xl w-full bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
      ...
      <p className="text-slate-600 mb-6">
        Khu vực này được bảo mật nghiêm ngặt. Chỉ người dùng có vai trò <span className="font-bold">admin</span> mới có thể xem trang này.
      </p>
      ...
      <div className="grid grid-cols-1 gap-4 mb-8">
        ...
        >
          ...
          <div className="ml-4">
            <h3 className="font-bold text-slate-900 text-lg">Quản lý Người dùng</h3>
            <p className="text-sm text-slate-500">Quản lý tài khoản, vai trò và trạng thái người dùng.</p>
          </div>
        </Link>
        ...
        >
          ...
          <div className="ml-4">
            <h3 className="font-bold text-slate-900 text-lg">Quản lý Danh mục</h3>
            <p className="text-sm text-slate-500">Tạo và tổ chức các danh mục tài liệu.</p>
          </div>
        </Link>
        <Link 
        ...
        >
          ...
          <div className="ml-4">
            <h3 className="font-bold text-slate-900 text-lg">Duyệt Tài liệu</h3>
            <p className="text-sm text-slate-500">Phê duyệt hoặc từ chối tài liệu do giáo viên tải lên.</p>
          </div>
        </Link>
      </div>
